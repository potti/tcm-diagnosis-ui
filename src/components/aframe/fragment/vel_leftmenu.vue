    ...
    <aside class="vel_leftmenu" :style="{ width: width + 'px' }">
        <el-scrollbar style="height: 100%">
            <div class="logo" :style="{ width: width + 'px' }">
                ...
                <span class="logo_tit">脉诊舌诊信息网络系统</span>
            </div>
            <el-menu :style="{ width: width + 'px' }"
                :unique-opened="true" :default-active="left_menu_active_index"
                :default-openeds="left_menu_openeds_index" :background-color="left_menu_background_color">
